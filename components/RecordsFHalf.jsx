...
export function RecordsFHalf() {
  return (
    <div className="flex flex-col w-[282px] min-h-[1080px] bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-[24px_16px] gap-6 mt-6">
      ...
      <div>
        <form>
          <input type="search" className="h-8 w-[250px] border border-gray-300 bg-gray-100 px-4 py-1 rounded-[8px] font-normal text-base text-[#1F2937] outline-none" placeholder="Search"/>
        </form>
      </div>
      <div className="flex flex-col gap-4">
        ...
        <div>
          <div className="flex gap-2 px-3 py-1 items-center">
            <div><input className="size-4 rounded-full border border-[#374151]" type="radio"/></div>
